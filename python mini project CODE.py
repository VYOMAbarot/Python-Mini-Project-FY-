...
level = str(input("Choose the difficulty level from Easy\n Medium\n Hard\n Impossible"))
if level == "Easy" or level == "easy":
    ...
    difficulty = 8
elif level == "Impossible" or level == "impossible":
    difficulty = 10
# Window size
X = 720
Y = 480
...
yellow = pygame.Color(110, 110,50)
...
while True:
    ...
    for pos in snake_body:
        ...
        pygame.draw.rect(display_surface,green, pygame.Rect(pos[0], pos[1], 10, 10))
...
level = str(input("Choose the difficulty level from\n Easy\n Medium\n Hard\n Impossible"))
if level == "Easy":
    difficulty = 4
elif level == "Medium":
    difficulty = 8
...
while True:
    ...
    for pos in snake_body:
        ...
        # .draw.rect(play_surface, color, xy-coordinate)
        # xy-coordinate -> .Rect(x, y, size_x, size_y)
        pygame.draw.rect(display_surface,yellow, pygame.Rect(pos[0], pos[1], 30, 30))
...
def level():
    level_surface = font.render('Choose the difficulty level from Easy(press e) Medium(press m ) Hard(press h) Impossible(press i)', True, red)
    level_rect = level_surface.get_rect()
    level_rect.midtop = (X/2, Y/4)
    display_surface.fill(black)
